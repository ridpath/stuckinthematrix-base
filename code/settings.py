...
# UI Colors (Matrix Glow)
WATER_COLOR = '#051405'  # Background tint
UI_BG_COLOR = '#111111'
UI_BORDER_COLOR = '#0f0f0f'
TEXT_COLOR = '#00FF00'

HEALTH_COLOR = '#00AA00'               # Green for STABILITY
ENERGY_COLOR = '#007777'               # Teal for BUFFER
UI_BORDER_COLOR_ACTIVE = '#00FF00'

# Aliases for lore-consistent labels
STABILITY_COLOR = HEALTH_COLOR
BUFFER_COLOR = ENERGY_COLOR
...
monster_data = {
    ...
    'spirit': {
        ...
        'damage': 8,
        'attack_type': 'thunder',
        'attack_sound': fireball_sound_path,
        'speed': 200,
        'resistance': 3,
        'attack_radius': 60,
        'notice_radius': 350
